...
template ECDSAPrivToPubNew(n, k) {
    var stride = 8;
    ...
    component hhhh1 = Poseidon(4);  
    hhhh1.inputs[0] <== privkey[0];
    hhhh1.inputs[1] <== privkey[1];   
    hhhh1.inputs[2] <== privkey[2];
    hhhh1.inputs[3] <== privkey[3];
    temp1 <== hhhh1.out;

    component hhhh2 = Poseidon(4);  
    hhhh2.inputs[0] <== temp1;
    hhhh2.inputs[1] <== nonceA;  
    hhhh2.inputs[2] <== nonceB;
    hhhh2.inputs[3] <== nonceC; 
    privkeyHash <== hhhh2.out;
